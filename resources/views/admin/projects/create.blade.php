<x-layout-admin>
    <x-slot:title>Créer un projet — Admin</x-slot:title>
    ...
    <div style="display:flex;flex-direction:column;gap:1.5rem;max-width:48rem;margin:0 auto;">
        ...
        <div>
            ...
            <h1 style="font-size:1.75rem;font-weight:700;color:var(--text-primary);letter-spacing:-0.02em;">Créer un nouveau projet</h1>
        </div>
            ...
            <div class="card" style="padding:2rem;">
                ...
                <div style="display:flex;flex-direction:column;gap:1.25rem;">
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title') }}" class="form-input" placeholder="Ex: Refonte Dashboard E-commerce" />
                    ...
                    <div>
                        ...
                        <input type="text" name="short_desc" value="{{ old('short_desc') }}" class="form-input" placeholder="Une phrase accrocheuse pour décrire le projet" />
                    ...
                    <div>
                        ...
                        <textarea name="full_desc" rows="6" class="form-input" placeholder="Détails du projet, défis, solutions..." style="resize:vertical;">{{ old('full_desc') }}</textarea>
            ...
            <div class="card" style="padding:2rem;">
                ...
                <div style="display:flex;flex-direction:column;gap:1.25rem;">
                    ...
                    <div>
                        ...
                        <input type="text" name="tech_stack" value="{{ old('tech_stack') }}" class="form-input" placeholder="Laravel, Vue.js, TailwindCSS..." />
                ...
                <div style="display:flex;flex-direction:column;gap:1.25rem;">
                    ...
                    <div style="margin-top:1rem;">
                        <label style="display:inline-flex;align-items:center;gap:0.75rem;cursor:pointer;">
                            <input type="checkbox" name="featured" value="1" {{ old('featured') ? 'checked' : '' }} style="width:1.25rem;height:1.25rem;border-radius:0.25rem;background:var(--bg-surface);border:1px solid var(--border);" />
